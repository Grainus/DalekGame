...
class GameView(EventListener):
    ...
    def afficher_header(self, niveau, score):
        ...
        print()
        print( ("Difficulty: " + diff).center(int(posx*1/3)) +f"Niveau: {niveau}".center(int((posx * 1/3))) + f"Score: {score}".center(int(posx*1/3)))
        print()
    ...
    def afficher_les_cases(grid):
        ...
        for row in grid.cells: 
            ...
            for i in range(height):
                ...
                # you mean rstrip() ??
                print(output.center(get_terminal_size().columns - between_x-1))
            print('\n' * (between_y-2))  
